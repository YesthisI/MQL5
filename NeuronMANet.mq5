//+------------------------------------------------------------------+
//                                                    NeuroMAnet.mq5 |
//|                                  Copyright 2024, SE Borovikov. A.
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
#property copyright "Copyright 2024, SE Borovikov. A."
...
//--- available signals
#include <Expert\Signal\SignalButterfly.mqh>
//--- available trailing
...
ulong                    Expert_MagicNumber   =123456;       //
...
input int                Signal_MA_PeriodMA   =14;          // Moving Average(12,0,...) Period of averaging
input int                Signal_MA_Shift      =0;           // Moving Average(12,0,...) Time shift
input double             Signal_MA_Weight     =30;         // Moving Average(12,0,...) Weight [0...1.0]
...
//--- Creating filter CSignalMA
   CSignalnMA *filter0=new CSignalnMA;
   if(filter0==NULL)
     {
      //--- failed
